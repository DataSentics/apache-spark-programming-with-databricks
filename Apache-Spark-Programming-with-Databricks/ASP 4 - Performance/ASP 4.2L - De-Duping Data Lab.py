...
df2 = (df1.withColumn("ssn", F.regexp_replace(col("ssn"), "-", ""))
       .withColumn("firstName", F.upper(col("firstName")))
       .withColumn("middleName", F.upper(col("middleName")))
       .withColumn("lastName", F.upper(col("lastName")))
       .dropDuplicates())
