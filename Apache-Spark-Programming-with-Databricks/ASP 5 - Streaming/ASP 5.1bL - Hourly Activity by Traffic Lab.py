...
from pyspark.sql.functions import  approx_count_distinct, window, hour , col
spark.conf.set("spark.sql.shuffle.partitions", 8)

traffic_df = (events_df
              .groupBy(col("traffic_source"), window(col("createdAt"),"1 hours"))
...
display(traffic_df,"hourly_traffic")
